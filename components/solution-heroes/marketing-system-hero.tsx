...
// ── Hardcoded config for Paid Growth Engine — edit only this file ──
const IMAGE_SRC =
  "https://images.unsplash.com/photo-1591696205602-2f950c417cb9?w=960&q=85";
const CARD_VALUE = "6X";
const CARD_LABEL = "ROAS Delivered";
const CARD_SUBLABEL = "On managed ad spend";

type Props = { solution: SolutionConfig };

export function MarketingSystemHero({ solution }: Props) {
  const IconComp = ICON_MAP[solution.iconName as keyof typeof ICON_MAP] ?? Target;
    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-7xl items-center gap-10 px-6 md:px-10 lg:grid-cols-[1fr_1fr] lg:gap-14 xl:gap-16">
        ...
        >
          ...
          >
            <span className="block">Spending on Ads but</span>
            <span className="block mt-1">
              Not Seeing It in Your Bank{" "}
              <motion.span
        ...
        >
          ...
          >
            <div className="relative aspect-[4/3] w-full">
              <Image
                src={IMAGE_SRC}
                alt="Paid advertising strategy session"
                fill

...
// ── Hardcoded config for Growth Foundation System — edit only this file ──
const IMAGE_SRC =
  "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=960&q=85";
const CARD_VALUE = "4.9★";
const CARD_LABEL = "Client Rating";
const CARD_SUBLABEL = "Avg. across all engagements";

type Props = { solution: SolutionConfig };

export function GrowthFoundationHero({ solution }: Props) {
  const IconComp = ICON_MAP[solution.iconName as keyof typeof ICON_MAP] ?? Compass;
    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-7xl items-center gap-10 px-6 md:px-10 lg:grid-cols-[1fr_1fr] lg:gap-14 xl:gap-16">
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="font-heading text-[clamp(2rem,3.2vw,3.6rem)] leading-[1.12] font-extrabold tracking-[-0.025em] text-white"
          >
            <span className="block">Not Sure Where to</span>
